...
import type { ApplicationCommandController, AutocompleteInteractionController, ComponentInteractionController, ModalSubmitInteractionController } from "../controllers/controller";
...
export class HttpOnlyBot {
    ...
    private defaultInteractionRoute(req: IncomingMessage, res: ServerResponse<IncomingMessage>, data: { type: InteractionType, data: { name?: string, custom_id?: string } }, buffer: Buffer) {
